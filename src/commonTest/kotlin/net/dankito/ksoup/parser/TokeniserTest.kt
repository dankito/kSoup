...
import net.dankito.ksoup.nodes.CDataNode
...
class TokeniserTest {
    ...
    fun handleLargeComment() {
        ...
        assertEquals(" $comment ", child.data)
    }
    ...
    fun handleLargeCdata() {
        ...
        assertEquals(cdata, child.wholeText)
    }
    ...
    fun handleLargeTitle() {
        ...
        assertEquals(title, child.wholeText)
    ...
    fun canParseVeryLongBogusComment() {
        ...
        assertEquals(expectedCommentData, (commentNode as Comment).data)
    }
