...
class CommentTest {
    ...
    @Test
    fun data() {
        assertEquals(" This is one heck of a comment! ", comment.data)
    }
...
<p><!-- comment --> Text</p>""", out
    ...
    fun testClone() {
        ...
        assertEquals(comment.data, comment.data)
        c1.setData("New")
        assertEquals("New", c1.data)
        assertNotEquals(c1.data, comment.data)
    }
