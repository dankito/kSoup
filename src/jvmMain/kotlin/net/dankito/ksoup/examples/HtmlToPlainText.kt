 ...
 *
 * `java -cp jsoup.jar net.dankito.ksoup.examples.HtmlToPlainText url [selector]`
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            Validate.isTrue(
                ...
                "usage: java -cp jsoup.jar net.dankito.ksoup.examples.HtmlToPlainText url [selector]"
            )
