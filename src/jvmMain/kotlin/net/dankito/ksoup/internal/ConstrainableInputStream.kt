...
class ConstrainableInputStream private constructor(`in`: InputStream?, bufferSize: Int, maxSize: Int) :
    ...
    companion object {
         ...
         */
        fun wrap(input: InputStream?, bufferSize: Int, maxSize: Int): ConstrainableInputStream {
            return (input as? ConstrainableInputStream)
                ?: ConstrainableInputStream(input, bufferSize, maxSize)
        }
    }
}
