...
class ParseTest {
    ...
    fun testHtml5Charset() {
        ...
        var doc = Jsoup.parse(`in`, null, "http://example.com/") //gb2312, has html5 <meta charset>
    ...
    fun testXwiki() {
        ...
        val doc = Jsoup.parse(`in`, null, "https://localhost/")
    ...
    fun testXwikiExpanded() {
        ...
        val doc = Jsoup.parse(GZIPInputStream(FileInputStream(`in`)), "UTF-8", "https://localhost/", parser.setTrackErrors(100))
