...
import net.dankito.ksoup.platform.*
...
class Document(private val location: String) :
     ...
     * @see net.dankito.ksoup.Jsoup.parse
     * @see .createShell
     */
    init {
    ...
    override fun createInstanceForClone() = Document(location)
     ...
     */
    class OutputSettings : Cloneable<OutputSettings> {
        /**
