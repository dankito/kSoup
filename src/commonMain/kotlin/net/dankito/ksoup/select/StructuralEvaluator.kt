...
import net.dankito.ksoup.jvm.IdentityHashMap
...
internal abstract class StructuralEvaluator(val evaluator: Evaluator) : Evaluator() {
    ...
    val threadMemo = ThreadLocal<IdentityHashMap<Element, IdentityHashMap<Element, Boolean>>> { IdentityHashMap() }
