...
class Tag private constructor(
    ...
    override fun clone(): Tag {
        ...
        clone.isBlock = isBlock
        clone.formatAsBlock = formatAsBlock
        clone.isEmpty = isEmpty
        clone.selfClosing = selfClosing
        clone.preserveWhitespace = preserveWhitespace
        clone.isFormListed = isFormListed
        clone.isFormSubmittable = isFormSubmittable
