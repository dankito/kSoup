package org.jsoup.internalimport
...
class StringUtilTest {
    @Test
    fun join() {
        Assertions.assertEquals("", join(listOf(""), " "))
        Assertions.assertEquals("one", join(listOf("one"), " "))
        Assertions.assertEquals("one two three", join(mutableListOf<String?>("one", "two", "three"), " "))
    }
