...
class ParseTest {
    ...
    fun testHtml5Charset() {
        ...
        var `in`: File = ParseTest.Companion.getFile("/htmltests/meta-charset-1.html")
        ...
        `in` = ParseTest.Companion.getFile("/htmltests/meta-charset-2.html") //
        ...
        `in` = ParseTest.Companion.getFile("/htmltests/meta-charset-3.html")
    ...
    fun testBrokenHtml5CharsetWithASingleDoubleQuote() {
        val `in`: InputStream = ParseTest.Companion.inputStreamFrom(
            """
    <html>
    ...
    fun testLowercaseUtf8Charset() {
        val `in`: File = ParseTest.Companion.getFile("/htmltests/lowercase-charset-test.html")
    ...
    fun testXwiki() {
        ...
        val `in`: File = ParseTest.Companion.getFile("/htmltests/xwiki-1324.html.gz")
    ...
    fun testXwikiExpanded() {
        ...
        val `in`: File = ParseTest.Companion.getFile("/htmltests/xwiki-edit.html.gz")
    ...
    fun testWikiExpandedFromString() {
        val `in`: File = ParseTest.Companion.getFile("/htmltests/xwiki-edit.html.gz")
        val html: String = ParseTest.Companion.getFileAsString(`in`)
